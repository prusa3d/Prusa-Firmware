...
#define FILAMENT_SIZE "2_85mm_MK2S" //"1_75mm_MK25"
#define NOZZLE_TYPE "E3Dv6full"

//Change LOAD and UNLOAD settings if you change DIA from 2.85mm to 1.75mm
#define DEFAULT_NOMINAL_FILAMENT_DIA  2.85 //1.75  //Enter the diameter (in mm) of the filament generally used (3.0 mm or 1.75 mm). Used by the volumetric extrusion.
...
// Electronics
#define MOTHERBOARD BOARD_RAMPS_13_EFB //BOARD_RAMBO_MINI_1_3
...
//#define DEBUG_BUILD  //KO KONČAŠ ZAKOMENTIRAJ!!!
#ifdef DEBUG_BUILD
//#define _NO_ASM
...
// Define Prusa filament runout sensor
	...
	//#define FILAMENT_RUNOUT_SUPPORT
		...
		#define FILAMENT_RUNOUT_SCRIPT "M600" //Added from MK2 config file!
	#endif
#endif
...
#if MOTHERBOARD == BOARD_RAMPS_13_EFB  //CHECK BEFORE COMPILE!
	//for Prusa Bear upgrade:
	#define X_PROBE_OFFSET_FROM_EXTRUDER 23    // Z probe to nozzle X offset: -left  +right
	#define Y_PROBE_OFFSET_FROM_EXTRUDER 4     // Z probe to nozzle Y offset: -front +behind
	#define Z_PROBE_OFFSET_FROM_EXTRUDER 0 //-0.4  // Z probe to nozzle Z offset: -below (always!)
#else
	#define X_PROBE_OFFSET_FROM_EXTRUDER 23     // Z probe to nozzle X offset: -left  +right
...
#define Z_BABYSTEP_MIN -5999 //-3999
