...
const char * const MSG_ADJUSTZ_LANG_TABLE[1] PROGMEM = {
	MSG_ADJUSTZ_EN
};
...
const char * const MSG_BABYSTEP_Z_LANG_TABLE[1] PROGMEM = {
	MSG_BABYSTEP_Z_EN
};
...
const char * const MSG_BABYSTEP_Z_NOT_SET_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_LEVELING_FAILED_POINT_LOW_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_LEVELING_FAILED_PROBE_DISCONNECTED_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_FAILED_FRONT_BOTH_FAR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_FAILED_FRONT_LEFT_FAR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_FAILED_FRONT_RIGHT_FAR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_FITTING_FAILED_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_POINT_NOT_FOUND_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_SKEW_EXTREME_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_SKEW_MILD_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_WARNING_FRONT_BOTH_FAR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_WARNING_FRONT_LEFT_FAR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_BED_SKEW_OFFSET_DETECTION_WARNING_FRONT_RIGHT_FAR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_CALIBRATE_BED_LANG_TABLE[1] PROGMEM = {
	MSG_CALIBRATE_BED_EN
};

const char MSG_CALIBRATE_BED_RESET_EN[] PROGMEM = "Reset XYZ calibr.";
const char * const MSG_CALIBRATE_BED_RESET_LANG_TABLE[1] PROGMEM = {
...
const char MSG_CALIBRATE_Z_AUTO_EN[] PROGMEM = "msg calibrate z auto";
...
const char * const MSG_CARD_MENU_LANG_TABLE[1] PROGMEM = {
	MSG_CARD_MENU_EN
};
...
const char * const MSG_CHANGE_SUCCESS_LANG_TABLE[1] PROGMEM = {
	MSG_CHANGE_SUCCESS_EN
};

const char MSG_CHANGING_FILAMENT_EN[] PROGMEM = "Changing filament!";
const char * const MSG_CHANGING_FILAMENT_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_CONFIRM_CARRIAGE_AT_THE_TOP_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_CONFIRM_NOZZLE_CLEAN_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_COOLDOWN_LANG_TABLE[1] PROGMEM = {
	MSG_COOLDOWN_EN
};

const char MSG_CORRECTLY_EN[] PROGMEM = "Changed correctly?";
const char * const MSG_CORRECTLY_LANG_TABLE[1] PROGMEM = {
	MSG_CORRECTLY_EN
};
...
const char * const MSG_DISABLE_STEPPERS_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_ERROR_LANG_TABLE[1] PROGMEM = {
	MSG_ERROR_EN
};
...
const char * const MSG_FAN_SPEED_LANG_TABLE[1] PROGMEM = {
	MSG_FAN_SPEED_EN
};
...
const char * const MSG_FILAMENTCHANGE_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_FIND_BED_OFFSET_AND_SKEW_LINE1_LANG_TABLE[1] PROGMEM = {
	MSG_FIND_BED_OFFSET_AND_SKEW_LINE1_EN
};

const char MSG_FIND_BED_OFFSET_AND_SKEW_LINE2_EN[] PROGMEM = " of 4";
const char * const MSG_FIND_BED_OFFSET_AND_SKEW_LINE2_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_FLOW_LANG_TABLE[1] PROGMEM = {
	MSG_FLOW_EN
};
...
const char * const MSG_FOLLOW_CALIBRATION_FLOW_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_IMPROVE_BED_OFFSET_AND_SKEW_LINE1_LANG_TABLE[1] PROGMEM = {
	MSG_IMPROVE_BED_OFFSET_AND_SKEW_LINE1_EN
};

const char MSG_IMPROVE_BED_OFFSET_AND_SKEW_LINE2_EN[] PROGMEM = " of 9";
const char * const MSG_IMPROVE_BED_OFFSET_AND_SKEW_LINE2_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_INSERT_FILAMENT_LANG_TABLE[1] PROGMEM = {
...
const char MSG_LANGUAGE_NAME_CZ[] PROGMEM = "cz";
const char MSG_LANGUAGE_NAME_IT[] PROGMEM = "it";
const char MSG_LANGUAGE_NAME_ES[] PROGMEM = "es";
const char MSG_LANGUAGE_NAME_PL[] PROGMEM = "pl";
const char MSG_LANGUAGE_NAME_DE[] PROGMEM = "de";
...
const char * const MSG_LANGUAGE_SELECT_LANG_TABLE[1] PROGMEM = {
	MSG_LANGUAGE_SELECT_EN
};

const char MSG_LOADING_COLOR_EN[] PROGMEM = "Loading color";
const char * const MSG_LOADING_COLOR_LANG_TABLE[1] PROGMEM = {
	MSG_LOADING_COLOR_EN
};

const char MSG_LOADING_FILAMENT_EN[] PROGMEM = "Loading filament";
const char * const MSG_LOADING_FILAMENT_LANG_TABLE[1] PROGMEM = {
	MSG_LOADING_FILAMENT_EN
};

const char MSG_LOAD_ALL_EN[] PROGMEM = "Load all";
const char * const MSG_LOAD_ALL_LANG_TABLE[1] PROGMEM = {
	MSG_LOAD_ALL_EN
};
...
const char * const MSG_MAIN_LANG_TABLE[1] PROGMEM = {
	MSG_MAIN_EN
};
...
const char * const MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE1_LANG_TABLE[1] PROGMEM = {
	MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE1_EN
};

const char MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE2_EN[] PROGMEM = " of 9";
const char * const MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE2_LANG_TABLE[1] PROGMEM = {
	MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE2_EN
};

const char MSG_MENU_CALIBRATION_EN[] PROGMEM = "Calibration";
const char * const MSG_MENU_CALIBRATION_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_MOVE_AXIS_LANG_TABLE[1] PROGMEM = {
	MSG_MOVE_AXIS_EN
};
...
const char * const MSG_MOVE_CARRIAGE_TO_THE_TOP_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_MOVE_CARRIAGE_TO_THE_TOP_Z_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_MOVE_X_LANG_TABLE[1] PROGMEM = {
	MSG_MOVE_X_EN
};

const char MSG_MOVE_Y_EN[] PROGMEM = "Move Y";
const char * const MSG_MOVE_Y_LANG_TABLE[1] PROGMEM = {
	MSG_MOVE_Y_EN
};

const char MSG_MOVE_Z_EN[] PROGMEM = "Move Z";
const char * const MSG_MOVE_Z_LANG_TABLE[1] PROGMEM = {
	MSG_MOVE_Z_EN
};

const char MSG_NEW_FIRMWARE_AVAILABLE_EN[] PROGMEM = "New firmware version available:";
const char * const MSG_NEW_FIRMWARE_AVAILABLE_LANG_TABLE[1] PROGMEM = {
	MSG_NEW_FIRMWARE_AVAILABLE_EN
};

const char MSG_NEW_FIRMWARE_PLEASE_UPGRADE_EN[] PROGMEM = "Please upgrade.";
const char * const MSG_NEW_FIRMWARE_PLEASE_UPGRADE_LANG_TABLE[1] PROGMEM = {
	MSG_NEW_FIRMWARE_PLEASE_UPGRADE_EN
};

const char MSG_NO_EN[] PROGMEM = "No";
const char * const MSG_NO_LANG_TABLE[1] PROGMEM = {
	MSG_NO_EN
};

const char MSG_NOT_COLOR_EN[] PROGMEM = "Color not clear";
const char * const MSG_NOT_COLOR_LANG_TABLE[1] PROGMEM = {
	MSG_NOT_COLOR_EN
};

const char MSG_NOT_LOADED_EN[] PROGMEM = "Filament not loaded";
const char * const MSG_NOT_LOADED_LANG_TABLE[1] PROGMEM = {
	MSG_NOT_LOADED_EN
};

const char MSG_NOZZLE_EN[] PROGMEM = "Nozzle";
const char * const MSG_NOZZLE_LANG_TABLE[1] PROGMEM = {
	MSG_NOZZLE_EN
};
...
const char * const MSG_NO_CARD_LANG_TABLE[1] PROGMEM = {
	MSG_NO_CARD_EN
};
...
const char * const MSG_PAPER_LANG_TABLE[1] PROGMEM = {
	MSG_PAPER_EN
};

const char MSG_PAUSE_PRINT_EN[] PROGMEM = "Pause print";
const char * const MSG_PAUSE_PRINT_LANG_TABLE[1] PROGMEM = {
	MSG_PAUSE_PRINT_EN
};

const char MSG_PICK_Z_EN[] PROGMEM = "Pick print";
const char * const MSG_PICK_Z_LANG_TABLE[1] PROGMEM = {
	MSG_PICK_Z_EN
};
...
const char * const MSG_PLEASE_WAIT_LANG_TABLE[1] PROGMEM = {
	MSG_PLEASE_WAIT_EN
};
...
const char * const MSG_PREHEAT_LANG_TABLE[1] PROGMEM = {
	MSG_PREHEAT_EN
};

const char MSG_PREHEAT_NOZZLE_EN[] PROGMEM = "Preheat the nozzle!";
const char * const MSG_PREHEAT_NOZZLE_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_PRESS_LANG_TABLE[1] PROGMEM = {
	MSG_PRESS_EN
};
...
const char * const MSG_PRINT_ABORTED_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_PRUSA3D_LANG_TABLE[1] PROGMEM = {
	MSG_PRUSA3D_EN
};

const char MSG_PRUSA3D_FORUM_EN[] PROGMEM = "forum.prusa3d.com";
const char * const MSG_PRUSA3D_FORUM_LANG_TABLE[1] PROGMEM = {
	MSG_PRUSA3D_FORUM_EN
};

const char MSG_PRUSA3D_HOWTO_EN[] PROGMEM = "howto.prusa3d.com";
const char * const MSG_PRUSA3D_HOWTO_LANG_TABLE[1] PROGMEM = {
	MSG_PRUSA3D_HOWTO_EN
};

const char MSG_REBOOT_EN[] PROGMEM = "Reboot the printer";
const char * const MSG_REBOOT_LANG_TABLE[1] PROGMEM = {
	MSG_REBOOT_EN
};
...
const char * const MSG_RESUME_PRINT_LANG_TABLE[1] PROGMEM = {
	MSG_RESUME_PRINT_EN
};

const char MSG_RESUMING_EN[] PROGMEM = "Resuming print";
const char * const MSG_RESUMING_LANG_TABLE[1] PROGMEM = {
	MSG_RESUMING_EN
};
...
const char * const MSG_SD_INSERTED_LANG_TABLE[1] PROGMEM = {
	MSG_SD_INSERTED_EN
};
...
const char * const MSG_SD_REMOVED_LANG_TABLE[1] PROGMEM = {
	MSG_SD_REMOVED_EN
};
...
const char * const MSG_SELFTEST_EXTRUDER_FAN_LANG_TABLE[1] PROGMEM = {
	MSG_SELFTEST_EXTRUDER_FAN_EN
};

const char MSG_SELFTEST_FAILED_EN[] PROGMEM = "Selftest failed  ";
const char * const MSG_SELFTEST_FAILED_LANG_TABLE[1] PROGMEM = {
	MSG_SELFTEST_FAILED_EN
};

const char MSG_SELFTEST_FAN_EN[] PROGMEM = "Fan test";;
const char * const MSG_SELFTEST_FAN_LANG_TABLE[1] PROGMEM = {
	MSG_SELFTEST_FAN_EN
};

const char MSG_SELFTEST_FAN_NO_EN[] PROGMEM = "Not spinning";;
const char * const MSG_SELFTEST_FAN_NO_LANG_TABLE[1] PROGMEM = {
	MSG_SELFTEST_FAN_NO_EN
};

const char MSG_SELFTEST_FAN_YES_EN[] PROGMEM = "Spinning";;
const char * const MSG_SELFTEST_FAN_YES_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_SELFTEST_NOTCONNECTED_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_SELFTEST_PLEASECHECK_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_SELFTEST_WIRINGERROR_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_SETTINGS_LANG_TABLE[1] PROGMEM = {
	MSG_SETTINGS_EN
};
...
const char * const MSG_SHOW_END_STOPS_LANG_TABLE[1] PROGMEM = {
	MSG_SHOW_END_STOPS_EN
};

const char MSG_SILENT_MODE_OFF_EN[] PROGMEM = "Mode [high power]";
const char * const MSG_SILENT_MODE_OFF_LANG_TABLE[1] PROGMEM = {
	MSG_SILENT_MODE_OFF_EN
};

const char MSG_SILENT_MODE_ON_EN[] PROGMEM = "Mode     [silent]";
const char * const MSG_SILENT_MODE_ON_LANG_TABLE[1] PROGMEM = {
...
const char * const MSG_SPEED_LANG_TABLE[1] PROGMEM = {
	MSG_SPEED_EN
};
...
const char * const MSG_STOP_PRINT_LANG_TABLE[1] PROGMEM = {
	MSG_STOP_PRINT_EN
};
...
const char * const MSG_SUPPORT_LANG_TABLE[1] PROGMEM = {
	MSG_SUPPORT_EN
};

const char MSG_SWITCH_PS_OFF_EN[] PROGMEM = "Switch power off";
const char * const MSG_SWITCH_PS_OFF_LANG_TABLE[1] PROGMEM = {
	MSG_SWITCH_PS_OFF_EN
};

const char MSG_SWITCH_PS_ON_EN[] PROGMEM = "Switch power on";
const char * const MSG_SWITCH_PS_ON_LANG_TABLE[1] PROGMEM = {
	MSG_SWITCH_PS_ON_EN
};

const char MSG_TAKE_EFFECT_EN[] PROGMEM = " for take effect";
const char * const MSG_TAKE_EFFECT_LANG_TABLE[1] PROGMEM = {
	MSG_TAKE_EFFECT_EN
};

const char MSG_TEMPERATURE_EN[] PROGMEM = "Temperature";
const char * const MSG_TEMPERATURE_LANG_TABLE[1] PROGMEM = {
	MSG_TEMPERATURE_EN
};
...
const char * const MSG_TUNE_LANG_TABLE[1] PROGMEM = {
	MSG_TUNE_EN
};
...
const char * const MSG_WATCH_LANG_TABLE[1] PROGMEM = {
	MSG_WATCH_EN
};
...
const char * const MSG_YES_LANG_TABLE[1] PROGMEM = {
	MSG_YES_EN
};
...
const char * const WELCOME_MSG_LANG_TABLE[1] PROGMEM = {
	WELCOME_MSG_EN
};
