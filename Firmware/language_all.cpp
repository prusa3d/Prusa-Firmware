...
const char MSG_BABYSTEP_Z_NOT_SET_DE[] PROGMEM = "Der Abstand zwischen der Spitze der Duese und der Printoberflaeche/Bed ist noch nicht eingestellt. Bitte folgen Sie dem Handbuch, First steps, section First layer calibration.";
...
const char MSG_NOZZLE1_DE[] PROGMEM = "Duese2";
...
const char MSG_NOZZLE2_DE[] PROGMEM = "Duese3";
...
const char MSG_PICK_Z_DE[] PROGMEM = "Waehle print";
