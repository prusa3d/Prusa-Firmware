...
const char MSG_BED_CORRECTION_MENU_ES[] PROGMEM = "Corr. de la heatbed";
...
const char MSG_CONFIRM_CARRIAGE_AT_THE_TOP_ES[] PROGMEM = "Esta la izq./der. del eje-X totalmente arriba?";
