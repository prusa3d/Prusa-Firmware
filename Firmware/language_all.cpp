...
const char MSG_IS_MULTI_MATERIAL_OFF_EN[] PROGMEM = "Multi Material [NO]";
const char MSG_IS_MULTI_MATERIAL_OFF_CZ[] PROGMEM = "Multi Material [NO]";
const char MSG_IS_MULTI_MATERIAL_OFF_IT[] PROGMEM = "Multi Material [NO]";
const char MSG_IS_MULTI_MATERIAL_OFF_ES[] PROGMEM = "Multi Material [NO]";
const char MSG_IS_MULTI_MATERIAL_OFF_PL[] PROGMEM = "Multi Material [NO]";
const char MSG_IS_MULTI_MATERIAL_OFF_DE[] PROGMEM = "Multi Material [NO]";
const char * const MSG_IS_MULTI_MATERIAL_OFF_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_IS_MULTI_MATERIAL_OFF_EN,
	MSG_IS_MULTI_MATERIAL_OFF_CZ,
	MSG_IS_MULTI_MATERIAL_OFF_IT,
	MSG_IS_MULTI_MATERIAL_OFF_ES,
	MSG_IS_MULTI_MATERIAL_OFF_PL,
	MSG_IS_MULTI_MATERIAL_OFF_DE
};

const char MSG_IS_MULTI_MATERIAL_ON_EN[] PROGMEM = "Multi Material [YES]";
const char MSG_IS_MULTI_MATERIAL_ON_CZ[] PROGMEM = "Multi Material [YES]";
const char MSG_IS_MULTI_MATERIAL_ON_IT[] PROGMEM = "Multi Material [YES]";
const char MSG_IS_MULTI_MATERIAL_ON_ES[] PROGMEM = "Multi Material [YES]";
const char MSG_IS_MULTI_MATERIAL_ON_PL[] PROGMEM = "Multi Material [YES]";
const char MSG_IS_MULTI_MATERIAL_ON_DE[] PROGMEM = "Multi Material [YES]";
const char * const MSG_IS_MULTI_MATERIAL_ON_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_IS_MULTI_MATERIAL_ON_EN,
	MSG_IS_MULTI_MATERIAL_ON_CZ,
	MSG_IS_MULTI_MATERIAL_ON_IT,
	MSG_IS_MULTI_MATERIAL_ON_ES,
	MSG_IS_MULTI_MATERIAL_ON_PL,
	MSG_IS_MULTI_MATERIAL_ON_DE
};
