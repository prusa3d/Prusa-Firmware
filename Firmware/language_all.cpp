...
const char MSG_FILAMENT_NOTIFICATION_MODE_CONTINUOUS_EN[] PROGMEM = "Fil Notif [continuous]";
const char * const MSG_FILAMENT_NOTIFICATION_MODE_CONTINUOUS_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_FILAMENT_NOTIFICATION_MODE_CONTINUOUS_EN,
};

const char MSG_FILAMENT_NOTIFICATION_MODE_SHORT_EN[] PROGMEM = "Fil Notif [short]";
const char * const MSG_FILAMENT_NOTIFICATION_MODE_SHORT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_FILAMENT_NOTIFICATION_MODE_SHORT_EN,
};

const char MSG_FILAMENT_NOTIFICATION_MODE_SILENT_EN[] PROGMEM = "Fil Notif [silent]";
const char * const MSG_FILAMENT_NOTIFICATION_MODE_SILENT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_FILAMENT_NOTIFICATION_MODE_SILENT_EN,
};
