...
const char MSG_BED_CORRECTION_FRONT_CENTR_ES[] PROGMEM = "Adelante  [um]";
const char MSG_BED_CORRECTION_FRONT_CENTR_PL[] PROGMEM = "Do przodu [um]";
const char MSG_BED_CORRECTION_FRONT_CENTR_DE[] PROGMEM = "Vor.Zentr [um]";
const char MSG_BED_CORRECTION_FRONT_CENTR_NL[] PROGMEM = "Voor.Centr[um]";
const char * const MSG_BED_CORRECTION_FRONT_CENTR_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_FRONT_CENTR_EN,
	MSG_BED_CORRECTION_FRONT_CENTR_CZ,
	MSG_BED_CORRECTION_FRONT_CENTR_IT,
	MSG_BED_CORRECTION_FRONT_CENTR_ES,
	MSG_BED_CORRECTION_FRONT_CENTR_PL,
	MSG_BED_CORRECTION_FRONT_CENTR_DE,
	MSG_BED_CORRECTION_FRONT_CENTR_NL
};

const char MSG_BED_CORRECTION_FRONT_LEFT_EN[] PROGMEM = "FrontLeft [um]";
const char MSG_BED_CORRECTION_FRONT_LEFT_DE[] PROGMEM = "Vor.Links [um]";
const char MSG_BED_CORRECTION_FRONT_LEFT_NL[] PROGMEM = "Voor.Links[um]";
const char * const MSG_BED_CORRECTION_FRONT_LEFT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_FRONT_LEFT_EN,
	MSG_BED_CORRECTION_FRONT_LEFT_EN,
	MSG_BED_CORRECTION_FRONT_LEFT_EN,
	MSG_BED_CORRECTION_FRONT_LEFT_EN,
	MSG_BED_CORRECTION_FRONT_LEFT_EN,
	MSG_BED_CORRECTION_FRONT_LEFT_DE,
	MSG_BED_CORRECTION_FRONT_LEFT_NL
};

const char MSG_BED_CORRECTION_FRONT_RIGHT_EN[] PROGMEM = "FrontRight[um]";
const char MSG_BED_CORRECTION_FRONT_RIGHT_DE[] PROGMEM = "Vor.Rechts[um]";
const char MSG_BED_CORRECTION_FRONT_RIGHT_NL[] PROGMEM = "Voor.Recht[um]";
const char * const MSG_BED_CORRECTION_FRONT_RIGHT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_FRONT_RIGHT_EN,
	MSG_BED_CORRECTION_FRONT_RIGHT_EN,
	MSG_BED_CORRECTION_FRONT_RIGHT_EN,
	MSG_BED_CORRECTION_FRONT_RIGHT_EN,
	MSG_BED_CORRECTION_FRONT_RIGHT_EN,
	MSG_BED_CORRECTION_FRONT_RIGHT_DE,
	MSG_BED_CORRECTION_FRONT_RIGHT_NL
};
...
const char MSG_BED_CORRECTION_MID_LEFT_EN[] PROGMEM = "MidLeft   [um]";
const char MSG_BED_CORRECTION_MID_LEFT_CZ[] PROGMEM = "Vlevo  [um]";
const char MSG_BED_CORRECTION_MID_LEFT_IT[] PROGMEM = "Sinistra  [um]";
const char MSG_BED_CORRECTION_MID_LEFT_ES[] PROGMEM = "Izquierda [um]";
const char MSG_BED_CORRECTION_MID_LEFT_PL[] PROGMEM = "W lewo  [um]";
const char MSG_BED_CORRECTION_MID_LEFT_DE[] PROGMEM = "Mi.Links  [um]";
const char MSG_BED_CORRECTION_MID_LEFT_NL[] PROGMEM = "Mid.Links [um]";
const char * const MSG_BED_CORRECTION_MID_LEFT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_MID_LEFT_EN,
	MSG_BED_CORRECTION_MID_LEFT_CZ,
	MSG_BED_CORRECTION_MID_LEFT_IT,
	MSG_BED_CORRECTION_MID_LEFT_ES,
	MSG_BED_CORRECTION_MID_LEFT_PL,
	MSG_BED_CORRECTION_MID_LEFT_DE,
	MSG_BED_CORRECTION_MID_LEFT_NL
};

const char MSG_BED_CORRECTION_MID_RIGHT_EN[] PROGMEM = "MidRight  [um]";
const char MSG_BED_CORRECTION_MID_RIGHT_CZ[] PROGMEM = "Vpravo [um]";
const char MSG_BED_CORRECTION_MID_RIGHT_IT[] PROGMEM = "Destra    [um]";
const char MSG_BED_CORRECTION_MID_RIGHT_ES[] PROGMEM = "Derecha   [um]";
const char MSG_BED_CORRECTION_MID_RIGHT_PL[] PROGMEM = "W prawo [um]";
const char MSG_BED_CORRECTION_MID_RIGHT_DE[] PROGMEM = "Mi.Rechts [um]";
const char MSG_BED_CORRECTION_MID_RIGHT_NL[] PROGMEM = "Mid.Rechts[um]";
const char * const MSG_BED_CORRECTION_MID_RIGHT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_MID_RIGHT_EN,
	MSG_BED_CORRECTION_MID_RIGHT_CZ,
	MSG_BED_CORRECTION_MID_RIGHT_IT,
	MSG_BED_CORRECTION_MID_RIGHT_ES,
	MSG_BED_CORRECTION_MID_RIGHT_PL,
	MSG_BED_CORRECTION_MID_RIGHT_DE,
	MSG_BED_CORRECTION_MID_RIGHT_NL
};

const char MSG_BED_CORRECTION_REAR_CENTR_EN[] PROGMEM = "RearCentr [um]";
const char MSG_BED_CORRECTION_REAR_CENTR_CZ[] PROGMEM = "Vzadu  [um]";
const char MSG_BED_CORRECTION_REAR_CENTR_IT[] PROGMEM = "Retro     [um]";
const char MSG_BED_CORRECTION_REAR_CENTR_ES[] PROGMEM = "Atras     [um]";
const char MSG_BED_CORRECTION_REAR_CENTR_PL[] PROGMEM = "Do tylu  [um]";
const char MSG_BED_CORRECTION_REAR_CENTR_DE[] PROGMEM = "Hin.Zentr [um]";
const char MSG_BED_CORRECTION_REAR_CENTR_NL[] PROGMEM = "Ach.Centr [um]";
const char * const MSG_BED_CORRECTION_REAR_CENTR_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_REAR_CENTR_EN,
	MSG_BED_CORRECTION_REAR_CENTR_CZ,
	MSG_BED_CORRECTION_REAR_CENTR_IT,
	MSG_BED_CORRECTION_REAR_CENTR_ES,
	MSG_BED_CORRECTION_REAR_CENTR_PL,
	MSG_BED_CORRECTION_REAR_CENTR_DE,
	MSG_BED_CORRECTION_REAR_CENTR_NL
};

const char MSG_BED_CORRECTION_REAR_LEFT_EN[] PROGMEM = "RearLeft  [um]";
const char MSG_BED_CORRECTION_REAR_LEFT_DE[] PROGMEM = "Hin.Links [um]";
const char MSG_BED_CORRECTION_REAR_LEFT_NL[] PROGMEM = "Ach.Links [um]";
const char * const MSG_BED_CORRECTION_REAR_LEFT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_REAR_LEFT_EN,
	MSG_BED_CORRECTION_REAR_LEFT_EN,
	MSG_BED_CORRECTION_REAR_LEFT_EN,
	MSG_BED_CORRECTION_REAR_LEFT_EN,
	MSG_BED_CORRECTION_REAR_LEFT_EN,
	MSG_BED_CORRECTION_REAR_LEFT_DE,
	MSG_BED_CORRECTION_REAR_LEFT_NL
};

const char MSG_BED_CORRECTION_REAR_RIGHT_EN[] PROGMEM = "RearRight [um]";
const char MSG_BED_CORRECTION_REAR_RIGHT_DE[] PROGMEM = "Hin.Rechts[um]";
const char MSG_BED_CORRECTION_REAR_RIGHT_NL[] PROGMEM = "Ach.Rechts[um]";
const char * const MSG_BED_CORRECTION_REAR_RIGHT_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BED_CORRECTION_REAR_RIGHT_EN,
	MSG_BED_CORRECTION_REAR_RIGHT_EN,
	MSG_BED_CORRECTION_REAR_RIGHT_EN,
	MSG_BED_CORRECTION_REAR_RIGHT_EN,
	MSG_BED_CORRECTION_REAR_RIGHT_EN,
	MSG_BED_CORRECTION_REAR_RIGHT_DE,
	MSG_BED_CORRECTION_REAR_RIGHT_NL
};
...
const char MSG_FILE_CNT_NL[] PROGMEM = "Sommige bestanden worden niet gesorteerd omdat de max. 100 bestanden per map is.";
...
const char MSG_FILE_INCOMPLETE_DE[] PROGMEM = "Bestand unvollstaedig. Trotzdem weiter machen?";
const char MSG_FILE_INCOMPLETE_NL[] PROGMEM = "Bestand onvolledig. Maar toch doorgaan?";
...
const char MSG_PICK_Z_NL[] PROGMEM = "Kies print";
...
const char MSG_PLA_FILAMENT_LOADED_NL[] PROGMEM = "Is PLA filament geladen?";
...
const char MSG_PLEASE_LOAD_PLA_NL[] PROGMEM = "Laad eerst PLA filament. aub";
...
const char MSG_V2_CALIBRATION_NL[] PROGMEM = "Eerste layer cal.";
...
const char MSG_WIZARD_NL[] PROGMEM = "Assistent";
...
const char MSG_WIZARD_CALIBRATION_FAILED_DE[] PROGMEM = "Bitte ueberpruefe unser Handbuch und behebe das Problem. Fahre dann mit dem Assistenten fort, indem Du den Drucker neu startest.";
const char MSG_WIZARD_CALIBRATION_FAILED_NL[] PROGMEM = "Controleer alstublieft ons handboek en los het probleem op. Vervolgens hervat de wizard door de printer opnieuw te starten.";
const char * const MSG_WIZARD_CALIBRATION_FAILED_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_WIZARD_CALIBRATION_FAILED_NL
};
...
const char MSG_WIZARD_CLEAN_HEATBED_NL[] PROGMEM = "Maak de bed schoon en druk de knop.";
...
const char MSG_WIZARD_DONE_NL[] PROGMEM = "Klaar. Happy printing!";
...
const char MSG_WIZARD_FILAMENT_LOADED_NL[] PROGMEM = "Filament geladen?";
...
const char MSG_WIZARD_HEATING_NL[] PROGMEM = "Opwarmen van de tuit. Wacht aub.";
...
const char MSG_WIZARD_INSERT_CORRECT_FILAMENT_NL[] PROGMEM = "Laad aub PLA-filament en hervat de wizard door de printer opnieuw te starten.";
const char * const MSG_WIZARD_INSERT_CORRECT_FILAMENT_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_WIZARD_INSERT_CORRECT_FILAMENT_NL
};
...
const char MSG_WIZARD_LANGUAGE_NL[] PROGMEM = "Kies de taal";
...
const char MSG_WIZARD_LOAD_FILAMENT_NL[] PROGMEM = "Plaats PLA filament in de extruder, druk dan op knop om het te laden.";
...
const char MSG_WIZARD_PLA_FILAMENT_NL[] PROGMEM = "Is het PLA filament?";
...
const char MSG_WIZARD_QUIT_NL[] PROGMEM = "U kunt de wizard altijd uit Kalibratie -> Assistent kiezen.";
...
const char MSG_WIZARD_REPEAT_V2_CAL_NL[] PROGMEM = "Wilt u de laatste stap herhalen om de afstand tussen tuit en bed te herstellen?";
...
const char MSG_WIZARD_RERUN_NL[] PROGMEM = "Starten van deWizard verwijdert de huidige kalibreringsresultaten en begint vanaf het begin. Doorgaan?";
...
const char MSG_WIZARD_SELFTEST_NL[] PROGMEM = "Ten eerste zullen we de zelftest uitvoeren om de meest voorkomende montageproblemen te controleren.";
...
const char MSG_WIZARD_V2_CAL_NL[] PROGMEM = "Begin met kalibratie tussen tuit en bed.";
...
const char MSG_WIZARD_V2_CAL_2_NL[] PROGMEM = "Begin de Kal.-Linie te printen, draai de knop tot je de optimale hoogte bereikt. Controleer de afbeeldingen in ons handboek in hoofdstuk Calibration.";
...
const char MSG_WIZARD_WELCOME_NL[] PROGMEM = "Hallo, ik ben uw originele Prusa i3 printer. Zullen we beginnen met het installatieproces?";
...
const char MSG_WIZARD_WILL_PREHEAT_NL[] PROGMEM = "Opwarmen van de tuit voor PLA voor.";
...
const char MSG_WIZARD_XYZ_CAL_NL[] PROGMEM = "Begin nu met xyz-kalibratie. Het duurt ongeveer 12 min.";
...
const char MSG_WIZARD_Z_CAL_NL[] PROGMEM = "Begin nu met z-kalibratie.";
