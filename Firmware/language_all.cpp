...
const char MSG_A_RETRACT_DE[] PROGMEM = "A-einziehen";
const char MSG_A_RETRACT_NL[] PROGMEM = "A-terugtrekken";
...
const char MSG_BABYSTEPPING_Z_DE[] PROGMEM = "Einstellen Z";
const char MSG_BABYSTEPPING_Z_NL[] PROGMEM = "Instellen Z";
const char * const MSG_BABYSTEPPING_Z_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BABYSTEPPING_Z_EN,
	MSG_BABYSTEPPING_Z_DE,
	MSG_BABYSTEPPING_Z_NL
};
...
const char MSG_BABYSTEP_Z_NOT_SET_DE[] PROGMEM = "Der Abstand zwischen der Spitze der D\x81se und der Printoberfl\x84che/Bed ist noch nicht eingestellt. Bitte folgen Sie dem Handbuch, First steps, section First layer calibration.";
const char MSG_BABYSTEP_Z_NOT_SET_NL[] PROGMEM = "Afstand tussen tip van het tuit en het print oppervlak nog niet vastgesteld. Volg de handleiding, First steps, section First layer calibration.";
...
const char MSG_BED_DE[] PROGMEM = "Bed";
const char MSG_BED_NL[] PROGMEM = "Bed";
...
const char MSG_BED_CORRECTION_MENU_DE[] PROGMEM = "Oberfl\x84che korrekt";
...
const char MSG_BED_CORRECTION_REAR_DE[] PROGMEM = "R\x81ckseite  [um]";
...
const char MSG_BED_HEATING_DE[] PROGMEM = "Bed aufw\x84rmen";
...
const char MSG_BED_LEVELING_FAILED_POINT_HIGH_DE[] PROGMEM = "Bed-Nivellierung fehlgeschlagen. Sensor wurde zu hoch ausgel\x94st. Warte auf Reset.";
...
const char MSG_BED_LEVELING_FAILED_POINT_LOW_DE[] PROGMEM = "Bed-Nivellierung fehlgeschlagen. Sensor wurde nicht ausgel\x94st. Schmutz auf der D\x81se? Warte auf Reset.";
...
const char MSG_BED_SKEW_OFFSET_DETECTION_PERFECT_DE[] PROGMEM = "XYZ-Kalibrierung ok. X/Y-Achsen sind im Lot. Gl\x81ckwunsch!";
...
const char MSG_BEGIN_FILE_LIST_DE[] PROGMEM = "Beginn Dateiliste";
const char MSG_BEGIN_FILE_LIST_NL[] PROGMEM = "Begin file lijst";
const char * const MSG_BEGIN_FILE_LIST_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_BEGIN_FILE_LIST_EN,
	MSG_BEGIN_FILE_LIST_DE,
	MSG_BEGIN_FILE_LIST_NL
};
...
const char MSG_CARD_MENU_DE[] PROGMEM = "Print von SD";
...
const char MSG_CLEAN_NOZZLE_E_DE[] PROGMEM = "E-Kalibrierung beendet. Bitte reinigen Sie die D\x81se. Klicken wenn fertig";
...
const char MSG_CNG_SDCARD_DE[] PROGMEM = "Wechsel SD Karte";
const char MSG_CNG_SDCARD_NL[] PROGMEM = "Wissel SD card";
...
const char * const MSG_CONFIGURATION_VER_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_CONFIGURATION_VER_DE,
	MSG_CONFIGURATION_VER_NL
};
...
const char MSG_CONFIRM_CARRIAGE_AT_THE_TOP_DE[] PROGMEM = "Sind linke und rechte Z-Schlitten ganz oben?";
const char MSG_CONFIRM_CARRIAGE_AT_THE_TOP_NL[] PROGMEM = "Zijn linkse en rechtse Z-wagen heelemaal boven?";
...
const char MSG_CONFIRM_NOZZLE_CLEAN_FIL_ADJ_DE[] PROGMEM = "Filaments sind jetzt eingestellt. Bitte reinigen Sie die D\x81se zur Kalibrierung. Klicken wenn fertig.";
...
const char MSG_COOLDOWN_DE[] PROGMEM = "Abk\x81hlen";
...
const char MSG_ENDSTOPS_HIT_DE[] PROGMEM = "endstops hit: ";
const char MSG_ENDSTOPS_HIT_NL[] PROGMEM = "endstops hit: ";
...
const char MSG_ENDSTOP_OPEN_DE[] PROGMEM = "offen";
const char MSG_ENDSTOP_OPEN_NL[] PROGMEM = "open";
...
const char MSG_END_FILE_LIST_DE[] PROGMEM = "Ende Dateiliste";
const char MSG_END_FILE_LIST_NL[] PROGMEM = "Eind file lijst";
const char * const MSG_END_FILE_LIST_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_END_FILE_LIST_EN,
	MSG_END_FILE_LIST_DE,
	MSG_END_FILE_LIST_NL
};
...
const char MSG_ERR_CHECKSUM_MISMATCH_DE[] PROGMEM = "Checksum Fehler, Letzte Zeile: ";
const char MSG_ERR_CHECKSUM_MISMATCH_NL[] PROGMEM = "checksum fout, Laatste lijn: ";
const char * const MSG_ERR_CHECKSUM_MISMATCH_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_ERR_CHECKSUM_MISMATCH_EN,
	MSG_ERR_CHECKSUM_MISMATCH_DE,
	MSG_ERR_CHECKSUM_MISMATCH_NL
};

const char MSG_ERR_COLD_EXTRUDE_STOP_EN[] PROGMEM = " cold extrusion prevented";
const char MSG_ERR_COLD_EXTRUDE_STOP_DE[] PROGMEM = " kalte Extrusion verhindert";
const char MSG_ERR_COLD_EXTRUDE_STOP_NL[] PROGMEM = " koude extrusie voorkomen";
const char * const MSG_ERR_COLD_EXTRUDE_STOP_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_ERR_COLD_EXTRUDE_STOP_EN,
	MSG_ERR_COLD_EXTRUDE_STOP_DE,
	MSG_ERR_COLD_EXTRUDE_STOP_NL
};

const char MSG_ERR_KILLED_EN[] PROGMEM = "Printer halted. kill() called!";
const char MSG_ERR_KILLED_DE[] PROGMEM = "Printer gestoppt. kill() aufgerufen!";
const char MSG_ERR_KILLED_NL[] PROGMEM = "Printer gestopt. kill() called!";
...
const char MSG_ERR_LINE_NO_DE[] PROGMEM = "Zeilennummer ist nicht die letzte Zeilennummer + 1, Letzte Zeile:";
const char MSG_ERR_LINE_NO_NL[] PROGMEM = "Lijnnumer is niet de laatste lijnnummer + 1, Laatste Lijn:";
...
const char MSG_ERR_LONG_EXTRUDE_STOP_DE[] PROGMEM = " zu lange Extrusion verhindert";
const char MSG_ERR_LONG_EXTRUDE_STOP_NL[] PROGMEM = " te lange extrusie voorkomen";
const char * const MSG_ERR_LONG_EXTRUDE_STOP_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_ERR_LONG_EXTRUDE_STOP_EN,
	MSG_ERR_LONG_EXTRUDE_STOP_DE,
	MSG_ERR_LONG_EXTRUDE_STOP_NL
};

const char MSG_ERR_NO_CHECKSUM_EN[] PROGMEM = "No Checksum with line number, Last Line: ";
const char MSG_ERR_NO_CHECKSUM_DE[] PROGMEM = "Keine Checksum mit Zeilennummer, Letzte Zeile: ";
const char MSG_ERR_NO_CHECKSUM_NL[] PROGMEM = "Geen Checksum met lijnnummer Laatste Lijn: ";
const char * const MSG_ERR_NO_CHECKSUM_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_ERR_NO_CHECKSUM_EN,
	MSG_ERR_NO_CHECKSUM_DE,
	MSG_ERR_NO_CHECKSUM_NL
};

const char MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_EN[] PROGMEM = "No Line Number with checksum, Last Line: ";
const char MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_DE[] PROGMEM = "Keine Zeilennummer mit checksum, Letzte Zeile: ";
const char MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_NL[] PROGMEM = "Geen lijnnummer met checksum, Laatste Lijn: ";
const char * const MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_EN,
	MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_DE,
	MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM_NL
};

const char MSG_ERR_NO_THERMISTORS_EN[] PROGMEM = "No thermistors - no temperature";
const char MSG_ERR_NO_THERMISTORS_DE[] PROGMEM = "Keine Temp.sensoren - keine Temperatur";
const char MSG_ERR_NO_THERMISTORS_NL[] PROGMEM = "Geen Temp.sensoren - geen temperatuur";
const char * const MSG_ERR_NO_THERMISTORS_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_ERR_NO_THERMISTORS_EN,
	MSG_ERR_NO_THERMISTORS_DE,
	MSG_ERR_NO_THERMISTORS_NL
};
...
const char MSG_ERR_STOPPED_DE[] PROGMEM = "Der Drucker wurde aufgrund von Fehlern gestoppt. Beheben Sie den Fehler und verwenden Sie M999, um neu zu starten. (Temperatur wird reset. Stellen Sie es nach dem Neustart ein)";
const char MSG_ERR_STOPPED_NL[] PROGMEM = "Printer vanwege fouten gestopt. Repareer de fout en gebruiken M999 te herstarten. (Temperatuur is gereset. Stel het na het herstarten)";
...
const char MSG_EXTERNAL_RESET_DE[] PROGMEM = " Externe Reset";
const char MSG_EXTERNAL_RESET_NL[] PROGMEM = " Externe Reset";
const char * const MSG_EXTERNAL_RESET_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_EXTERNAL_RESET_EN,
	MSG_EXTERNAL_RESET_DE,
	MSG_EXTERNAL_RESET_NL
};
...
const char MSG_Enqueing_DE[] PROGMEM = "enqueing \"";
const char MSG_Enqueing_NL[] PROGMEM = "enqueing \"";
...
const char MSG_FACTOR_DE[] PROGMEM = " \002 Fakt";
const char MSG_FACTOR_NL[] PROGMEM = " \002 Feit";
...
const char MSG_FAN_SPEED_DE[] PROGMEM = "L\x81ftergeschwindingkeit";
...
const char MSG_FARM_CARD_MENU_DE[] PROGMEM = "Farm mode print";
const char MSG_FARM_CARD_MENU_NL[] PROGMEM = "Farm mode print";
const char * const MSG_FARM_CARD_MENU_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_FARM_CARD_MENU_EN,
	MSG_FARM_CARD_MENU_DE,
	MSG_FARM_CARD_MENU_NL
};
...
const char MSG_FILE_PRINTED_DE[] PROGMEM = "Datei print fertig.";
const char MSG_FILE_PRINTED_NL[] PROGMEM = "File print klaar.";
...
const char MSG_FILE_SAVED_DE[] PROGMEM = "Datei gespeichert.";
const char MSG_FILE_SAVED_NL[] PROGMEM = "File opgeslaan.";
...
const char MSG_FIND_BED_OFFSET_AND_SKEW_LINE1_DE[] PROGMEM = "Suche Bed Kalibrierpunkt";
const char MSG_FIND_BED_OFFSET_AND_SKEW_LINE1_NL[] PROGMEM = "Zoeken bed kalibratiepunt";
...
const char MSG_FLOW0_DE[] PROGMEM = "Durchfluss 0";
const char MSG_FLOW0_NL[] PROGMEM = "Flow 0";
...
const char MSG_FLOW1_DE[] PROGMEM = "Durchfluss 1";
const char MSG_FLOW1_NL[] PROGMEM = "Flow 1";
...
const char MSG_FLOW2_DE[] PROGMEM = "Durchfluss 2";
const char MSG_FLOW2_NL[] PROGMEM = "Flow 2";
...
const char MSG_FREE_MEMORY_DE[] PROGMEM = " Freier Speicher: ";
const char MSG_FREE_MEMORY_NL[] PROGMEM = " Vrij geheugen: ";
...
const char MSG_IMPROVE_BED_OFFSET_AND_SKEW_LINE1_NL[] PROGMEM = "Verbetering bed kalibratiepunt";
...
const char MSG_INVALID_EXTRUDER_DE[] PROGMEM = "Invalid extruder";
const char MSG_INVALID_EXTRUDER_NL[] PROGMEM = "Invalid extruder";
const char * const MSG_INVALID_EXTRUDER_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_INVALID_EXTRUDER_EN,
	MSG_INVALID_EXTRUDER_DE,
	MSG_INVALID_EXTRUDER_NL
};
...
const char MSG_LANGUAGE_SELECT_DE[] PROGMEM = "W\x84hle Sprache";
...
const char MSG_MARK_FIL_DE[] PROGMEM = "Markier Filament 100mm vom Extrudergeh\x84use. Klicken wenn Fertig.";
...
const char MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE1_DE[] PROGMEM = "Messen der Referenzh\x94he des Kalibrierpunktes";
...
const char MSG_NEW_FIRMWARE_AVAILABLE_DE[] PROGMEM = "Neue Firmware Fersion verf\x81gbar:";
...
const char MSG_NOZZLE_DE[] PROGMEM = "D\x81se";
...
const char MSG_NOZZLE1_DE[] PROGMEM = "D\x81se2";
const char MSG_NOZZLE1_NL[] PROGMEM = "Tuit2";
...
const char MSG_NOZZLE2_DE[] PROGMEM = "D\x81se3";
const char MSG_NOZZLE2_NL[] PROGMEM = "Tuit3";
...
const char MSG_OFF_DE[] PROGMEM = "Aus";
const char MSG_OFF_NL[] PROGMEM = "Uit";
...
const char MSG_ON_DE[] PROGMEM = "An ";
const char MSG_ON_NL[] PROGMEM = "Aan ";
...
const char MSG_PAPER_DE[] PROGMEM = "Legen ein Blatt Papier unter die D\x81se w\x84hrend der Kalibrierung der ersten 4 Punkte. Wenn die D\x81se das Papier einf\x84ngt, Drucker sofort ausschalten!";
...
const char MSG_PICK_Z_DE[] PROGMEM = "W\x84hle print";
...
const char MSG_PREHEAT_DE[] PROGMEM = "Vorw\x84rmen";
...
const char MSG_PREHEAT_NOZZLE_DE[] PROGMEM = "D\x81se vorw\x84rmen!";
...
const char MSG_PRESS_DE[] PROGMEM = "und Knopf dr\x81cken";
...
const char MSG_PRINT_ABORTED_DE[] PROGMEM = "Print abgebrochen";
...
const char MSG_RESUMING_DE[] PROGMEM = "Print wird fortgesetzt";
...
const char MSG_SD_CANT_ENTER_SUBDIR_DE[] PROGMEM = "Kann nicht ins Unterverz.: ";
const char MSG_SD_CANT_ENTER_SUBDIR_NL[] PROGMEM = "Kan niet in subdir: ";
const char * const MSG_SD_CANT_ENTER_SUBDIR_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_SD_CANT_ENTER_SUBDIR_EN,
	MSG_SD_CANT_ENTER_SUBDIR_DE,
	MSG_SD_CANT_ENTER_SUBDIR_NL
};

const char MSG_SD_CANT_OPEN_SUBDIR_EN[] PROGMEM = "Cannot open subdir";
const char MSG_SD_CANT_OPEN_SUBDIR_DE[] PROGMEM = "Kann Unterverz. nicht \x94ffnen";
...
const char * const MSG_SD_CANT_OPEN_SUBDIR_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_SD_CANT_OPEN_SUBDIR_DE,
	MSG_SD_CANT_OPEN_SUBDIR_NL
};
...
const char * const MSG_SD_ERR_WRITE_TO_FILE_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_SD_ERR_WRITE_TO_FILE_DE,
	MSG_SD_ERR_WRITE_TO_FILE_NL
};

const char MSG_SD_FILE_OPENED_EN[] PROGMEM = "File opened: ";
const char MSG_SD_FILE_OPENED_DE[] PROGMEM = "Datei ge\x94ffnet: ";
...
const char * const MSG_SD_FILE_OPENED_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_SD_FILE_OPENED_DE,
	MSG_SD_FILE_OPENED_NL
};

const char MSG_SD_FILE_SELECTED_EN[] PROGMEM = "File selected";
const char MSG_SD_FILE_SELECTED_DE[] PROGMEM = "Datei ausgew\x94hlt";
...
const char * const MSG_SD_FILE_SELECTED_LANG_TABLE[LANG_NUM] PROGMEM = {
	...
	MSG_SD_FILE_SELECTED_DE,
	MSG_SD_FILE_SELECTED_NL
};
...
const char MSG_SD_NOT_PRINTING_DE[] PROGMEM = "Kein SD Print";
const char MSG_SD_NOT_PRINTING_NL[] PROGMEM = "geen SD printen";
const char * const MSG_SD_NOT_PRINTING_LANG_TABLE[LANG_NUM] PROGMEM = {
	MSG_SD_NOT_PRINTING_EN,
	MSG_SD_NOT_PRINTING_DE,
	MSG_SD_NOT_PRINTING_NL
};
...
const char MSG_SELFTEST_COOLING_FAN_DE[] PROGMEM = "Vorderer Frontl\x81fter?";;
...
const char MSG_SELFTEST_EXTRUDER_FAN_DE[] PROGMEM = "Linker Hotend-L\x81fter?";;
...
const char MSG_SELFTEST_FAN_DE[] PROGMEM = "L\x81ftertest";;
...
const char MSG_SELFTEST_PLEASECHECK_DE[] PROGMEM = "Bitte pr\x81fe:  ";
...
const char MSG_STATS_PRINTTIME_DE[] PROGMEM = "Print Zeit:  ";
...
const char MSG_STATS_TOTALPRINTTIME_DE[] PROGMEM = "Totale print Zeit:";
...
const char MSG_WAITING_TEMP_DE[] PROGMEM = "Warten auf Abk\x81hlung von Heater und Bed.";
