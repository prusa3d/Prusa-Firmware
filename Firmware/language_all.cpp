...
const char MSG_ENDSTOPPULLUP_FIL_RUNOUT_OFF_EN[] PROGMEM = "Fil.RSPullup[OFF]";
const char * const MSG_ENDSTOPPULLUP_FIL_RUNOUT_OFF_LANG_TABLE[1] PROGMEM = {
	MSG_ENDSTOPPULLUP_FIL_RUNOUT_OFF_EN
};

const char MSG_ENDSTOPPULLUP_FIL_RUNOUT_ON_EN[] PROGMEM = "Fil.RSPullup [ON]";
