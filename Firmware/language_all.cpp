...
const char MSG_BABYSTEP_Z_NOT_SET_DE[] PROGMEM = "Der Abstand zwischen der Spitze der Duese und der Druckoberflaeche/Bed ist noch nicht eingestellt. Bitte folgen Sie dem Handbuch, First steps, section First layer calibration.";
...
const char MSG_ERR_KILLED_DE[] PROGMEM = "Drucker gestoppt. kill() aufgerufen!";
...
const char MSG_FARM_CARD_MENU_DE[] PROGMEM = "Farm mode Druck";
...
const char MSG_FILE_PRINTED_DE[] PROGMEM = "Datei druck fertig.";
...
const char MSG_SD_NOT_PRINTING_DE[] PROGMEM = "Kein SD Druck";
...
const char MSG_STORE_EPROM_DE[] PROGMEM = "Speichern in EPROM";
