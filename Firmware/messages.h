...
extern const char MSG_BED_CORRECTION_RESET[];
...
extern const char MSG_CALIBRATE_PINDA[];
...
extern const char MSG_FSENSOR_NA[];
...
extern const char MSG_SD_CARD_OK[];
extern const char MSG_SD_INIT_FAIL[];
extern const char MSG_SD_OPENROOT_FAIL[];
extern const char MSG_SD_VOL_INIT_FAIL[];
...
extern const char MSG_WIZARD_Z_CAL_1[];
extern const char MSG_WIZARD_Z_CAL_2[];
extern const char MSG_WIZARD_Z_CAL_3[];
...
extern const char MSG_SD_CANT_ENTER_SUBDIR[];
extern const char MSG_SD_ERR_WRITE_TO_FILE[];
extern const char MSG_SD_FILE_OPENED[];
extern const char MSG_SD_FILE_SELECTED[];
extern const char MSG_SD_OPEN_FILE_FAIL[];
extern const char MSG_SD_PRINTING_BYTE[];
extern const char MSG_SD_SIZE[];
extern const char MSG_SD_WRITE_TO_FILE[];
