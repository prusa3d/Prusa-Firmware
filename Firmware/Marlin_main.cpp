...
// musi byt PRED "PRUSA model"
    } else if (code_seen_P(PSTR("smodel"))) { //! PRUSA smodel
          size_t nOffset;
// ! -> "l"
    ...
    } else if (code_seen_P(PSTR("model"))) { //! PRUSA model
    ...
    } else if (code_seen_P(PSTR("version"))) { //! PRUSA version
    ...
    } else if (code_seen_P(PSTR("gcode"))) { //! PRUSA gcode
