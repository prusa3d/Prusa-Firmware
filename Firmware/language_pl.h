...
#define MSG_FIND_BED_OFFSET_AND_SKEW_LINE1  		"Szukam kalibracyj. punktu podkladki"
#define MSG_FIND_BED_OFFSET_AND_SKEW_LINE2  		" z 4"
#define MSG_IMPROVE_BED_OFFSET_AND_SKEW_LINE1   	"Ulepszam dokladnosc punktu kalibracyj."
