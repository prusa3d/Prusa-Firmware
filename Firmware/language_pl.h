...
#define(length=20) MSG_DISABLE_STEPPERS                "Wylaczyc silniki"
...
#define(length=15) MSG_FAN_SPEED                       "Predkosc went."
...
#define(length=20, lines=2) MSG_RESUMING                        "Wznowienie druku"
...
#define(length=20) MSG_ADJUSTZ                                         "Autodostroic Z?"
...
#define MSG_YES                                 "Tak"
#define MSG_NO                                  "Nie"
#define(length=20) MSG_NOT_LOADED                  "Brak filamentu"
#define(length=20) MSG_NOT_COLOR                  "Kolor zanieczysz."
#define(length=20) MSG_LOADING_FILAMENT            "Wprow. filamentu"
#define MSG_PLEASE_WAIT                 "Prosze czekac"
#define MSG_LOADING_COLOR               "Czyszcz. koloru"
#define(length=20) MSG_CHANGE_SUCCESS              "Wymiana ok!"
...
#define(length=20, lines=2) MSG_TAKE_EFFECT                                         " wprow. zmian"   
...
#define(length=20) MSG_SELFTEST_NOTCONNECTED           "Nie podlaczono   "
#define MSG_SELFTEST_HEATERTHERMISTOR       "Heater/Thermistor"
#define MSG_SELFTEST_BEDHEATER              "Bed / Heater"
#define(length=20) MSG_SELFTEST_WIRINGERROR            "Blad polaczenia"
...
#define(length=20) MSG_SELFTEST_FAN_NO					"Nekreci sie";
...
#define(length=20) MSG_SELFTEST_FAILED                 "Selftest nieudany"
...
#define(length=20, lines=8) MSG_CONFIRM_CARRIAGE_AT_THE_TOP     		"Oba wozki dojechaly do gornej ramy?"
...
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_POINT_LOW                       "Kalibracja nieudana. Sensor nie dotknal. Zanieczysz. dysza? Czekam na reset."
#define(length=20, lines=5) MSG_BED_LEVELING_FAILED_POINT_HIGH                      "Kalibracja Z nieudana. Sensor dotk. za wysoko. Czekam na reset."
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_PROBE_DISCONNECTED              "Kalibracja nieudana. Sensor odlaczony lub uszkodz. kabel. Czekam na reset."
#define(length=20, lines=2)  MSG_NEW_FIRMWARE_AVAILABLE                              "Wyszla nowa wersja firmware:"
...
#define(length=20) MSG_LOOSE_PULLEY										"Kolo pasowe"
...
#define(length=20, lines=2) MSG_FIL_LOADED_CHECK									"Czy filament jest wprowadzony?"
#define(length=20, lines=3) MSG_FIL_TUNING											"Obrotem przycisku dostroj pozycje filamentu."
...
#define(length=20, lines=2) MSG_FILAMENT_CLEAN										"Czy kolor jest czysty?"
#define(length=20) MSG_UNLOADING_FILAMENT									"Wysuwam filament"
#define(length=20, lines=10) MSG_PAPER												"Umiesc kartke papieru na podkladce i trzymaj pod dysza podczas pomiaru pierwszych 4 punktow. Jesli dysza zahaczy o papier, wylacz drukarke."