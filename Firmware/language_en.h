...
#define(length=20, lines=2) MSG_RESUMING                        "Resuming print"
...
#define MSG_YES					"Yes"
#define MSG_NO					"No"
#define(length=20) MSG_NOT_LOADED 			"Filament not loaded"
...
#define(length=20, lines=8) MSG_CONFIRM_CARRIAGE_AT_THE_TOP	"Are left and right Z-carriages all up?"
...
#define(length=20, lines=5) MSG_BED_LEVELING_FAILED_POINT_HIGH						"Bed leveling failed. Sensor triggered too high. Waiting for reset."
