...
#define MSG_SORT_ALPHA						"Sortieren: [Alphabet]"
...
#define MSG_FILE_INCOMPLETE					"Datei unvollständig. Trotzdem fortfahren?"
...
#define MSG_WIZARD_SELFTEST					"Zunächst führe ich den Selbsttest durch um die häufigsten Probleme bei der Aufbau zu überprüfen."
#define MSG_WIZARD_CALIBRATION_FAILED		"Bitte überprüfen Sie unser Handbuch und beheben Sie das Problem. Fahren Sie dann mit dem Assistenten fort, indem Sie den Drucker neu starten."
#define MSG_WIZARD_XYZ_CAL					"Ich werde jetzt die XYZ-Kalibrierung durchführen. Es wird ca. 12 Minuten dauern"
#define MSG_WIZARD_FILAMENT_LOADED			"Ist Filament geladen?"
#define MSG_WIZARD_Z_CAL					"Ich werde jetzt die Z Kalibrierung durchführen."
#define MSG_WIZARD_WILL_PREHEAT				"Jetzt werde ich die Düse für PLA vorheizen. "
#define MSG_WIZARD_V2_CAL					"Jetzt werde ich den Abstand zwischen Düsenspitze und Druckbett kalibrieren."
#define MSG_WIZARD_V2_CAL_2					"Ich werde jetzt erste Linie drucken. Während des Druckes können Sie die Düse allmählich senken indem Sie den Knopf drehen, bis Sie die optimale Höhe erreichen. Überprüfen Sie die Bilder in unserem Handbuch im Kapitel Kalibrierung."
#define MSG_V2_CALIBRATION					"Erste-Schicht Kalibrierung"
#define MSG_WIZARD_DONE						"Alles wurde getan. Viel Spaß beim Drucken!"
#define MSG_WIZARD_LOAD_FILAMENT			"Führen Sie bitte PLA Filament in den Extruder und bestätigen Sie den Knopf um es zu laden."
#define MSG_WIZARD_RERUN					"Der laufende Assistent löscht die aktuelle Kalibrierergebnisse und wird von Anfang an beginnen. Fortsetzen?"
#define MSG_WIZARD_REPEAT_V2_CAL			"Möchten Sie den letzten Schritt wiederholen um den Abstand zwischen Düse und Druckbett neu einzustellen?"
#define MSG_WIZARD_CLEAN_HEATBED			"Bitte reinigen Sie das Heizbett und drücken Sie dann den Knopf."
...
#define MSG_WIZARD_HEATING					"Vorheizen der Düse. Bitte warten."
