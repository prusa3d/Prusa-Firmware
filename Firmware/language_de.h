+/**
 ...
 + */
	...
	+ #define MSG_USERWAIT                        "Warte auf Benutzer..."
	...
	+ #define MSG_SELFTEST_ENDSTOP_NOTHIT			"Ende nicht erreicht"
...
+
+#define(length = 20) MSG_STATS_TOTALFILAMENT	"Gesamt Filament:"
+ #define(length = 20) MSG_STATS_TOTALPRINTTIME "Gesamt Druckzeit:"
...
+ #define(length = 20) MSG_SELFTEST_FAILED		"Selbsttest Fehlerhaft"
...
#define MSG_WIZARD							"Erste Schritte Assistent"
...
#define MSG_WIZARD_V2_CAL_2					"Ich werde jetzt die erste Linie drucken. Waehrend des Druckes koennen Sie die Duese allmaehlich senken indem Sie den Knopf drehen, bis Sie die optimale Hoehe erreichen. Ueberpruefen Sie die Bilder in unserem Handbuch im Kapitel Kalibrierung"
#define MSG_V2_CALIBRATION					"Erste-Schicht Kal"
#define MSG_WIZARD_DONE						"Alles wurde eingestellt. Viel Spass beim Drucken!"
