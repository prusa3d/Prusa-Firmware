...
#define MSG_DISABLE_STEPPERS                "Deaktiviere Motoren"
#define MSG_AUTO_HOME                       "Startposition"
#define MSG_SET_HOME_OFFSETS                "Set home offsets"
#define MSG_SET_ORIGIN                      "Set origin"
#define MSG_COOLDOWN                        "Abk\x81hlen"
...
#define MSG_NOZZLE                          "D\x81se"
#define MSG_NOZZLE1                         "D\x81se2"
#define MSG_NOZZLE2                         "D\x81se3"
#define MSG_BED                             "Bed"
#define MSG_FAN_SPEED                       "L\x81ftergeschwindingkeit"
...
#define MSG_RESUMING                        "Print wird fortgesetzt"
...
#define(length=20) MSG_PRESS				"und Knopf dr\x81cken"
...
#define MSG_BED_HEATING                     "Bed aufw\x84rmen
...
#define MSG_SD_CANT_OPEN_SUBDIR             "Kann Unterverz. nicht \x94ffnen"
...
#define MSG_SD_FILE_OPENED                  "Datei ge\x94ffnet: "
#define MSG_SD_FILE_SELECTED                "Datei ausgew\x94hlt"
...
#define MSG_LANGUAGE_SELECT					"W\x84hle Sprache"
...
#define MSG_SELFTEST_PLEASECHECK			"Bitte pr\x81fe:"	
...
#define MSG_SELFTEST_FAN					"L\x81ftertest";
#define(length=20) MSG_SELFTEST_COOLING_FAN			"Vorderer Frontl\x81fter?";
#define(length=20) MSG_SELFTEST_EXTRUDER_FAN			"Linker Hotend-L\x81fter?";
...
#define(length=20) MSG_SELFTEST_CHECK_ENDSTOPS		"Pr\x81fe endstops   "
#define(length=20) MSG_SELFTEST_CHECK_HOTEND		"Pr\x81fe hotend     "  
#define(length=20) MSG_SELFTEST_CHECK_X				"Pr\x81fe X Achse    "
#define(length=20) MSG_SELFTEST_CHECK_Y				"Pr\x81fe Y Achse    "
#define(length=20) MSG_SELFTEST_CHECK_Z				"Pr\x81fe Z Achse    "
...
#define(length=20,lines=8) MSG_CONFIRM_NOZZLE_CLEAN			"Bitte reinigen Sie die D\x81se zur Kalibrierung. Klicken wenn fertig."
...
#define(length=60) MSG_MEASURE_BED_REFERENCE_HEIGHT_LINE1	"Messen der Referenzh\x94he des Kalibrierpunktes"
...
#define(length=20,lines=8) MSG_BED_SKEW_OFFSET_DETECTION_PERFECT					"XYZ-Kalibrierung ok. X/Y-Achsen sind im Lot. Gl\x81ckwunsch!"
...
#define(length=20,lines=4) MSG_BED_LEVELING_FAILED_POINT_LOW						"Bed-Nivellierung fehlgeschlagen. Sensor wurde nicht ausgel\x94st. Schmutz auf der D\x81se? Warte auf Reset."
#define(length=20,lines=4) MSG_BED_LEVELING_FAILED_POINT_HIGH						"Bed-Nivellierung fehlgeschlagen. Sensor wurde zu hoch ausgel\x94st. Warte auf Reset."
...
#define(length=20,lines=2) MSG_NEW_FIRMWARE_AVAILABLE								"Neue Firmware Fersion verf\x81gbar:"
...
#define(length=20,lines=12) MSG_BABYSTEP_Z_NOT_SET									"Der Abstand zwischen der Spitze der D\x81se und der Printoberfl\x84che/Bed ist noch nicht eingestellt. Bitte folgen Sie dem Handbuch, First steps, section First layer calibration."
...
#define(length=20,lines=8) MSG_CONFIRM_NOZZLE_CLEAN_FIL_ADJ			"Filaments sind jetzt eingestellt. Bitte reinigen Sie die D\x81se zur Kalibrierung. Klicken wenn fertig."
...
#define(length=20, lines=8) MSG_MARK_FIL						"Markier Filament 100mm vom Extrudergeh\x84use. Klicken wenn Fertig."
#define(length=20, lines=8) MSG_CLEAN_NOZZLE_E				"E-Kalibrierung beendet. Bitte reinigen Sie die D\x81se. Klicken wenn fertig"
#define(length=20, lines=3) MSG_WAITING_TEMP				"Warten auf Abk\x81hlung von Heater und Bed."
...
#define(length=20, lines=8) MSG_PAPER						"Legen ein Blatt Papier unter die D\x81se w\x84hrend der Kalibrierung der ersten 4 Punkte. Wenn die D\x81se das Papier einf\x84ngt, Drucker sofort ausschalten"
...
#define MSG_BED_CORRECTION_REAR									"R\x81ckseite  [um]"
