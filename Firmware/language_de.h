...
#define (length=22) MSG_RESUMING             "Druck wird fortgesetzt"
...
#define(length=20, lines=8) MSG_PAPER						"Lege ein Blatt Papier unter die Duese waehrend der Kalibrierung der ersten 4 Punkte. Wenn die Duese das Papier einfaengt, Drucker sofort ausschalten"
