...
#define ENABLE_TEMPERATURE_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) TIMSK2 |= _BV(OCIE2B)
#define DISABLE_TEMPERATURE_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) TIMSK2 &= ~_BV(OCIE2B)

#else //SYSTEM_TIMER_2

#define ENABLE_TEMPERATURE_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) TIMSK0 |= _BV(OCIE0B)
#define DISABLE_TEMPERATURE_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) TIMSK0 &= ~_BV(OCIE0B)
