...
#define(length=20) MSG_DISABLE_STEPPERS                "Apagar motores"
...
#define MSG_BED                             "Base"
#define(length=15) MSG_FAN_SPEED                       "Velocidad Vent."
...
#define(length=20) MSG_USERWAIT                        "Esperando ordenes"
#define(length=20, lines=2) MSG_RESUMING                        "Resumiendo impresion"
#define MSG_PRINT_ABORTED                   "Impresion cancelada" 
#define MSG_NO_MOVE                         "Sin movimiento"
#define(length=20) MSG_KILLED                          "PARADA DE EMERGENCIA"
#define MSG_STOPPED                         "PARADA"
#define MSG_FILAMENTCHANGE                  "Cambiar filamento"
#define MSG_BABYSTEP_Z                      "Micropaso Eje Z"
#define(length=20) MSG_ADJUSTZ			    "Ajustar Eje Z"			
#define(length=20) MSG_PICK_Z			    "Esc. Modelo Adecuado"
...
#define MSG_YES								"Si"
#define MSG_NO								"No"
#define(length=20) MSG_NOT_LOADED 			    "Fil. no introducido"
#define(length=20) MSG_NOT_COLOR 			    "Color no homogeneo"
#define(length=20) MSG_LOADING_FILAMENT		    "Introduciendo filam."
#define MSG_PLEASE_WAIT			    "Por Favor Esperar"
#define MSG_LOADING_COLOR                   "Cambiando color" 
#define(length=20) MSG_CHANGE_SUCCESS		    "Cambio correcto"
...
#define(length=20, lines=2) MSG_TAKE_EFFECT			    " para aplicar cambios" 
...
#define(length=20) MSG_SELFTEST_ERROR                  "Autotest error!"
#define MSG_SELFTEST_PLEASECHECK            "Controla :"   
#define(length=20) MSG_SELFTEST_NOTCONNECTED           "No hay conexion  "
#define MSG_SELFTEST_HEATERTHERMISTOR       "Calent./Termistor"
#define MSG_SELFTEST_BEDHEATER              "Cama/Calentador"
#define(length=20) MSG_SELFTEST_WIRINGERROR            "Error de conexion"
#define MSG_SELFTEST_ENDSTOPS               "Topes final"
#define MSG_SELFTEST_MOTOR                  "Motor"
#define MSG_SELFTEST_ENDSTOP                "Tope final"
#define(length=20, lines=2) MSG_SELFTEST_ENDSTOP_NOTHIT         "Tope fin. no toc."
...
#define(length=20) MSG_SELFTEST_FAN_NO					"Ventilador no gira";
...
#define(length=20) MSG_SELFTEST_FAILED                 "Autotest fallado"
...
#define(length=20, lines=8) MSG_CONFIRM_CARRIAGE_AT_THE_TOP     "Carros Z izq./der. estan arriba maximo?"
...
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_POINT_LOW           				"Nivelacion fallada. Sensor no funciona. Escombros en Boqui.? Esperando reset."
#define(length=20, lines=5) MSG_BED_LEVELING_FAILED_POINT_HIGH          				"Nivelacion fallada. Sensor funciona demasiado temprano. Esperando reset."
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_PROBE_DISCONNECTED      			"Nivelacion fallada. Sensor desconectado o cables danados. Esperando reset."
#define(length=20, lines=2)  MSG_NEW_FIRMWARE_AVAILABLE                  				"Nuevo firmware disponible:"
...
#define(length=20) MSG_LOOSE_PULLEY								"Polea suelta"
...
#define(length=20, lines=2) MSG_FIL_LOADED_CHECK							"Esta cargado el filamento?"
#define(length=20, lines=3) MSG_FIL_TUNING									"Rotar el mando para ajustar el filamento."
...
#define(length=20, lines=2) MSG_FILAMENT_CLEAN								"Es el nuevo color nitido?"
#define(lenght=20) MSG_UNLOADING_FILAMENT							"Soltando filamento"
#define(length=20, lines=10) MSG_PAPER										"Colocar una hoja de papel sobre la superficie de impresion durante la calibracion de los primeros 4 puntos. Si la boquilla mueve el papel, apagar impresora inmediatamente."