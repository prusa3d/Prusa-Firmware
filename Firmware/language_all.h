...
extern const char* const MSG_FILAMENT_NOTIFICATION_MODE_CONTINUOUS_LANG_TABLE[LANG_NUM];
#define MSG_FILAMENT_NOTIFICATION_MODE_CONTINUOUS LANG_TABLE_SELECT(MSG_FILAMENT_NOTIFICATION_MODE_CONTINUOUS_LANG_TABLE)
extern const char* const MSG_FILAMENT_NOTIFICATION_MODE_SHORT_LANG_TABLE[LANG_NUM];
#define MSG_FILAMENT_NOTIFICATION_MODE_SHORT LANG_TABLE_SELECT(MSG_FILAMENT_NOTIFICATION_MODE_SHORT_LANG_TABLE)
extern const char* const MSG_FILAMENT_NOTIFICATION_MODE_SILENT_LANG_TABLE[LANG_NUM];
#define MSG_FILAMENT_NOTIFICATION_MODE_SILENT LANG_TABLE_SELECT(MSG_FILAMENT_NOTIFICATION_MODE_SILENT_LANG_TABLE)
