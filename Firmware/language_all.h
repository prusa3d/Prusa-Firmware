...
#define MSG_BED_CORRECTION_MID_LEFT LANG_TABLE_SELECT(MSG_BED_CORRECTION_MID_LEFT_LANG_TABLE)
extern const char* const MSG_BED_CORRECTION_MID_RIGHT_LANG_TABLE[LANG_NUM];
