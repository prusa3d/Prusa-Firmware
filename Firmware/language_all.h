...
extern const char* const MSG_IS_MULTI_MATERIAL_OFF_LANG_TABLE[LANG_NUM];
#define MSG_IS_MULTI_MATERIAL_OFF LANG_TABLE_SELECT(MSG_IS_MULTI_MATERIAL_OFF_LANG_TABLE)
extern const char* const MSG_IS_MULTI_MATERIAL_ON_LANG_TABLE[LANG_NUM];
#define MSG_IS_MULTI_MATERIAL_ON LANG_TABLE_SELECT(MSG_IS_MULTI_MATERIAL_ON_LANG_TABLE)
