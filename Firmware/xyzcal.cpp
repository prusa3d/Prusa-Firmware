...
#define ENABLE_FANCHECK_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) EIMSK |= _BV(INT7)
#define DISABLE_FANCHECK_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) EIMSK &= ~_BV(INT7)
