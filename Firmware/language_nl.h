...
#define(length=20) MSG_DISABLE_STEPPERS                "Deactiveren motoren"
...
#define MSG_BED                             "Bed"
#define(length=15) MSG_FAN_SPEED                       "Fan snelheid"
...
#define(length=20, lines=2) MSG_SELFTEST_ENDSTOP_NOTHIT			"Endstop niet geraakt"
