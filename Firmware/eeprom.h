...
// Maximum +-125 micrometers allowed ... can be stored in EEPROM.
// Bed correction is valid if set to 1. If set to zero or 255, the successive 4 bytes are invalid.

#ifdef HBL
#define EEPROM_BED_CORRECTION_FRONT_LEFT (EEPROM_BED_CALIBRATION_Z_JITTER - 1)
...
#define EEPROM_BED_CORRECTION_VALID (EEPROM_BED_CORRECTION_REAR_RIGHT-1)
#else
//#define EEPROM_FARM_MODE (EEPROM_BED_CALIBRATION_Z_JITTER-1)
//#define EEPROM_FARM_NUMBER (EEPROM_FARM_MODE-3)
