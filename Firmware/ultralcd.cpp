...
void unload_filament()
{
	...
	plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], FILAMENT_SINGLE_UNLOAD_SLOW_SEQUENCE_FIRST_HALF_FEED_RATE, active_extruder);
	st_synchronize();
	current_position[E_AXIS] -= FILAMENT_SINGLE_UNLOAD_SLOW_SEQUENCE_SECOND_HALF;
	plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], FILAMENT_SINGLE_UNLOAD_SLOW_SEQUENCE_SECOND_HALF_FEED_RATE, active_extruder);
	st_synchronize();
