...
#define(length=20) MSG_DISABLE_STEPPERS                "Disabilit motori"
...
#define(length=15) MSG_FAN_SPEED                       "Velocita vent."
...
#define(length=20) MSG_USERWAIT                        "Attendendo utente"
#define(length=20, lines=2) MSG_RESUMING                        "Riprendi stampa"
#define MSG_PRINT_ABORTED                   "Stampa abortita"
#define MSG_NO_MOVE                         "Nessun movimento."
#define(length=20) MSG_KILLED                          "IN TILT."
...
#define(length=20) MSG_ADJUSTZ			    			"Autoregolare Z?"
...
#define MSG_YES								"Si"
#define MSG_NO								"No"
#define(length=20) MSG_NOT_LOADED 						"Fil. non caricato"
#define(length=20) MSG_NOT_COLOR 						"Colore non puro"
#define MSG_LOADING_COLOR					"Caricando colore"
#define(length=20) MSG_CHANGE_SUCCESS					"Cambio riuscito!"
...
#define(length=20) MSG_LOADING_FILAMENT				"Caricando filam."
...
#define(length=20, lines=2) MSG_TAKE_EFFECT			    " per attualizzare"
...
#define(length=20) MSG_SELFTEST_FAN_NO					"Non si gira";
...
#define(length=20) MSG_SELFTEST_FAILED		    "Autotest fallito"
...
#define(length=20, lines=8) MSG_CONFIRM_CARRIAGE_AT_THE_TOP				"I carrelli Z sin/des sono altezza max?"
...
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_POINT_LOW				"Livellamento letto fallito.NoRispSensor Residui su ugello? In attesa di reset."
#define(length=20, lines=5) MSG_BED_LEVELING_FAILED_POINT_HIGH				"Livellamento letto fallito.Risp sensore troppo prestoIn attesa di reset."
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_PROBE_DISCONNECTED		"Livellamento letto fallito. Sensore discon. o Cavo Dann. In attesa di reset."

#define(length=20, lines=2)  MSG_NEW_FIRMWARE_AVAILABLE						"Nuova versione del firmware disponibile"
...
#define(length=20) MSG_LOOSE_PULLEY								"Puleggia lenta"
...
#define(length=20, lines=2) MSG_FIL_LOADED_CHECK							"Filamento caricato?"
#define(length=20, lines=3) MSG_FIL_TUNING									"Girare la manopola per regolare il filamento"
...
#define(length=20, lines=2) MSG_FILAMENT_CLEAN								"Il colore e' nitido?"
#define(length=20) MSG_UNLOADING_FILAMENT							"Rilasc. filamento"
#define(length=20, lines=10) MSG_PAPER										"Porre un foglio sotto l'ugello durante la calibrazione dei primi 4 punti. In caso l'ugello muova il foglio spegnere prontamente la stampante."