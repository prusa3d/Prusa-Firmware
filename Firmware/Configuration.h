...
#define MIN_Z_FOR_LOAD    1 // lcd filament loading or autoload
#define MIN_Z_FOR_UNLOAD  1 // lcd filament unloading
#define MIN_Z_FOR_SWAP    1 // filament change (including M600)
#define MIN_Z_FOR_PREHEAT 1 // lcd preheat
