...
#define ENABLE_STEPPER_DRIVER_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) TIMSK1 |= _BV(OCIE1A)
#define DISABLE_STEPPER_DRIVER_INTERRUPT() ATOMIC_BLOCK(ATOMIC_RESTORESTATE) TIMSK1 &= ~_BV(OCIE1A)
