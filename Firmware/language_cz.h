...
#define(length=20) MSG_DISABLE_STEPPERS                "Vypnout motory"
...
#define MSG_BED                             "Bed"
#define(length=15) MSG_FAN_SPEED                       "Rychlost vent."
...
#define(length=20, lines=2) MSG_RESUMING                        "Obnoveni tisku"
...
#define(length=20) MSG_ADJUSTZ							"Auto doladit Z ?"
#define(length=20) MSG_PICK_Z							"Vyberte vytisk"
...
#define MSG_YES					"Ano"
#define MSG_NO					"Ne"
#define(length=20) MSG_NOT_LOADED 			"Filament nezaveden"
#define(length=20) MSG_NOT_COLOR 			"Barva neni cista"
#define(length=20) MSG_LOADING_FILAMENT	        "Zavadeni filamentu"
#define MSG_PLEASE_WAIT			"Prosim cekejte"
#define MSG_LOADING_COLOR		"Cisteni barvy"
#define(length=20) MSG_CHANGE_SUCCESS		"Zmena uspesna!"
...
#define(length=20, lines=2) MSG_TAKE_EFFECT						" pro projeveni zmen"	
...
#define(length=20) MSG_SELFTEST_NOTCONNECTED			"Nezapojeno    "
#define MSG_SELFTEST_HEATERTHERMISTOR		"Heater/Thermistor"
#define MSG_SELFTEST_BEDHEATER				"Bed / Heater"
#define(length=20) MSG_SELFTEST_WIRINGERROR			"Chyba zapojeni"
#define MSG_SELFTEST_ENDSTOPS				"Endstops"
#define MSG_SELFTEST_MOTOR					"Motor"
#define MSG_SELFTEST_ENDSTOP				"Endstop"
#define(length=20, lines=2) MSG_SELFTEST_ENDSTOP_NOTHIT			"Endstop not hit"
...
#define(length=20) MSG_SELFTEST_FAN_NO					"Netoci se";
...
#define(length=20) MSG_SELFTEST_FAILED					"Selftest selhal  "
...
#define(length=20, lines=8) MSG_CONFIRM_CARRIAGE_AT_THE_TOP		"Dojely oba Z voziky k~hornimu dorazu?"
...
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_POINT_LOW						"Kalibrace Z selhala. Sensor nesepnul. Znecistena tryska? Cekam na reset."
#define(length=20, lines=5) MSG_BED_LEVELING_FAILED_POINT_HIGH						"Kalibrace Z selhala. Sensor sepnul prilis vysoko. Cekam na reset."
#define(length=20, lines=6) MSG_BED_LEVELING_FAILED_PROBE_DISCONNECTED				"Kalibrace Z selhala. Sensor je odpojeny nebo preruseny kabel. Cekam na reset."

#define(length=20, lines=2)  MSG_NEW_FIRMWARE_AVAILABLE								"Vysla nova verze firmware:"
...
#define(length=20) MSG_LOOSE_PULLEY								"Uvolnena remenicka"
...
#define(length=20, lines=2) MSG_FIL_LOADED_CHECK							"Je filament zaveden?"
#define(length=20, lines=3) MSG_FIL_TUNING									"Otacenim tlacitka doladte pozici filamentu."
...
#define(length=20, lines=1) MSG_CALIBRATE_E				"Kalibrovat E"
//#define(length=20, lines=1) MSG_RESET_CALIBRATE_E				"Reset E Cal."
#define(length=20, lines=8) MSG_E_CAL_KNOB				"Otacejte tlacitkem dokud znacka nedosahne tela extruderu. Potvrdte tlacitkem."
...
#define(length=20, lines=2) MSG_FILAMENT_CLEAN								"Je barva cista?" 
#define(length=20) MSG_UNLOADING_FILAMENT							"Vysouvam filament"

#define(length=20, lines=10) MSG_PAPER										"Umistete list papiru na podlozku a udrzujte jej pod tryskou behem mereni prvnich 4 bodu. Pokud tryska zachyti papir, vypnete tiskarnu."