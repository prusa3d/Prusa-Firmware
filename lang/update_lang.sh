...
if [ ! -e text.sym ]; then echo "$(tput setaf 2)NG!  file text.sym not found!$(tput sgr 0)" >&2; finish 1; fi
if [ ! -e lang_$LNG.bin ]; then echo "$(tput setaf 2)NG!  file lang_$LNG.bin not found!$(tput sgr 0)" >&2; finish 1; fi
if [ ! -e firmware.bin ]; then echo "$(tput setaf 2)NG!  file firmware.bin not found!$(tput sgr 0)" >&2; finish 1; fi
...
if [ -z "$sec_lang" ]; then echo "$(tput setaf 1)NG!\n  symbol _SEC_LANG not found!$(tput sgr 0)" >&2; finish 1; fi
