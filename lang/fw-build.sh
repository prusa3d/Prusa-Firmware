...
if [ -e lang_en.bin ]; then
 ...
 echo "$(tput setaf 2)NG! - file lang_en.bin not found!$(tput sgr 0)" >&2;
 finish 1
fi
...
if [ ! -z "$LNG" ]; then
 ...
 if [ $? -ne 0 ]; then echo "$(tput setaf 2)NG! - check update_lang.out file" >&2; finish 1; fi
 echo "$(tput setaf 2)OK$(tput sgr 0)" >&2
 finish 0
else
 echo
 ...
 if [ -e lang_cz.bin ]; then
  ...
  if [ $? -eq 0 ]; then echo "$(tput setaf 2)OK$(tput sgr 0)" >&2; else echo "$(tput setaf 1)NG!$(tput sgr0)" >&2; finish 1; fi
 fi
...
#Dutch
 if [ -e lang_nl.bin ]; then
  ...
  if [ $? -eq 0 ]; then echo "$(tput setaf 2)OK$(tput sgr 0)" >&2; else echo "$(tput setaf 1)NG!$(tput sgr0)" >&2; fi
 fi
